...
const sheetVariants = cva(
  "fixed z-50 flex flex-col gap-4 overflow-y-auto overscroll-contain bg-background p-6 shadow-lg transition ease-in-out [-webkit-overflow-scrolling:touch] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
  ...
  ({ side = "right", className, children, style, ...props }, ref) => (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          top: side === 'bottom' ? undefined : 'var(--vv-offset-top, 0px)',
          bottom: side === 'top' ? undefined : 'var(--vv-bottom, 0px)',
          height: side === 'top' || side === 'bottom' ? undefined : 'var(--vvh, 100dvh)',
